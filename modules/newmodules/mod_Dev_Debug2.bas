Attribute VB_Name = "mod_Dev_Debug2"
...
'    Getmod_Dev_Debug2lates
    
'    Getmod_Dev_Debug2late "u_surface_cover"
...
Public Function test()
    ...
    Removemod_Dev_Debug2lateQueries
 
    'Set g_Appmod_Dev_Debug2lates = Nothing
    'Getmod_Dev_Debug2lates
 
    'RunPlotCheck
    
    'Getmod_Dev_Debug2lateIDs

    'Getmod_Dev_Debug2lates
    
    'g_Appmod_Dev_Debug2lates.Items().Item ("qc_ndc_fuels1000hr_transects_all")
...
'
'
'strSQL = Getmod_Dev_Debug2late("s_event_by_park_river_w_location", _
'                    "ParkCode" & PARAM_SEPARATOR & mod_Dev_Debug2Vars("ParkCode") & _
'                    "|waterway" & PARAM_SEPARATOR & mod_Dev_Debug2Vars("River"))

'Debug.Print strSQL

'Getmod_Dev_Debug2late "i_event"

Getmod_Dev_Debug2late ("s_app_releases")
...
'    Dim mi As Variant
'    mi = "P"
'    DoCmd.RunSQL Getmod_Dev_Debug2late("TEST2")
'    Dim qdf As DAO.QueryDef
'    Set qdf = CurrentDb.QueryDefs("usys_mod_Dev_Debug2_qdf")
'    qdf.SQL = Getmod_Dev_Debug2late("TEST2")
...
'    a.Name = "my new array"
    ...
    mod_Dev_Debug2Vars("ContactID") = 1
...
'Params(0) = "s_tsys_mod_Dev_Debug2_photo_data"
'
'Set frm = Forms("Tree")
''LoadTree frm, frm.Controls("tvwTree").Object, "s_photo_data", params
'LoadTree frm, frm.Controls("tvwTree").Object, "s_usys_mod_Dev_Debug2_photo_data", Params
...
Public Sub DoIt2()
    Dim db As DAO.Database
    Dim qdf As DAO.QueryDef
    Dim mod_Dev_Debug2late As String
    
    mod_Dev_Debug2late = "i_site"
    
    Set db = CurrentDb
    
    With db
        Set qdf = .QueryDefs("usys_mod_Dev_Debug2_qdf")
        
        With qdf
        
            'check if record exists in site
            .SQL = Getmod_Dev_Debug2late(mod_Dev_Debug2late)
...
Public Sub CheckRS()
    ...
    Set rs = CurrentDb.OpenRecordset("usys_mod_Dev_Debug2_rs2", dbOpenDynaset)
'    Dim rs As Object
'
...
Public Function FixQDF(mod_Dev_Debug2late As String)
Dim db As DAO.Database
Dim qdf As DAO.QueryDef
Dim strSQL As String
    ...
    With db
        ...
        With qdf
            ...
            strSQL = "PARAMETERS vers FLOAT, sflag INTEGER, contxt TEXT(255), syntx TEXT(10)," _
                     ...
                     & "INSERT INTO tsys_Db_mod_Dev_Debug2lates (Version, IsSupported, Context, Syntax, mod_Dev_Debug2lateName, Params, mod_Dev_Debug2late, Remarks, EffectiveDate, RetireDate, CreateDate, CreatedBy_ID, LastModified, LastModifiedBy_ID)" _
                     & "VALUES" _
