...
'                   Dim NewTransect as framework.Transect
'                   Set NewTransect = framework.GetClass()
'               --------------------------------------------------------------------------
' Assumptions:  -
' Parameters:   -
...
' ---------------------------------
Public Function GetClass() As Transect
On Error GoTo Err_Handler

    Set GetClass = New Transect
    ...
    Select Case Err.Number
        Case Else
            MsgBox "Error #" & Err.Description, vbCritical, _
                "Error encounter (#" & Err.Number & " - GetClass[Transect class])"
    End Select
    Resume Exit_Handler
End Function
