...
'                   Dim NewSamplingEvent as framework.SamplingEvent
'                   Set NewSamplingEvent = framework.GetClass()
'               --------------------------------------------------------------------------
' Assumptions:  -
' Parameters:   -
...
' ---------------------------------
Public Function GetClass() As SamplingEvent
On Error GoTo Err_Handler

    Set GetClass = New SamplingEvent
    ...
    Select Case Err.Number
        Case Else
            MsgBox "Error #" & Err.Description, vbCritical, _
                "Error encounter (#" & Err.Number & " - GetClass[SamplingEvent class])"
    End Select
    Resume Exit_Handler
End Function
