...
'                   Dim NewQuadrat as framework.Quadrat
'                   Set NewQuadrat = framework.GetClass()
'               --------------------------------------------------------------------------
' Assumptions:  -
' Parameters:   -
...
' ---------------------------------
Public Function GetClass() As Quadrat
On Error GoTo Err_Handler

    Set GetClass = New Quadrat
    ...
    Select Case Err.Number
        Case Else
            MsgBox "Error #" & Err.Description, vbCritical, _
                "Error encounter (#" & Err.Number & " - GetClass[Quadrat class])"
    End Select
    Resume Exit_Handler
End Function
