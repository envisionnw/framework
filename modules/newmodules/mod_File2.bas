...
'       FOLDERID_CommonStartMenu        FOLDERID_ComputerFolder FOLDERID_Commonmod_File2lates
...
'       FOLDERID_SearchHome             FOLDERID_SEARCH_MAPI    FOLDERID_Searchmod_File2lates
...
'       FOLDERID_System                 FOLDERID_SystemX86      FOLDERID_mod_File2lates
...
'        AllUsersStartup        MyDocuments     Recent         mod_File2lates
...
Public Function ParseFileName(ByVal strFullPath As String) As String
    ...
    Dim strmod_File2 As String

    Do While (InStr(strFullPath, "\") > 0)
        strmod_File2 = strmod_File2 & Left$(strFullPath, InStr(strFullPath, "\"))
...
Public Function ParseFileExt(ByVal strFullPath As String, _
    ...
    If varPosition > 0 Then
        ...
        strmod_File2 = Mid$(strFile, varPosition)
    Else
        strmod_File2 = ""
    End If

    ParseFileExt = strmod_File2
