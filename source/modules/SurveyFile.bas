...
'                   Dim NewSurveyFile as framework.SurveyFile
'                   Set NewSurveyFile = framework.GetClass()
'               --------------------------------------------------------------------------
' Assumptions:  -
' Parameters:   -
...
' ---------------------------------
Public Function GetClass() As SurveyFile
On Error GoTo Err_Handler

    Set GetClass = New SurveyFile
    ...
    Select Case Err.Number
        Case Else
            MsgBox "Error #" & Err.Description, vbCritical, _
                "Error encounter (#" & Err.Number & " - GetClass[SurveyFile class])"
    End Select
    Resume Exit_Handler
End Function
