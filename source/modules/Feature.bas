...
'                   Dim NewFeature as framework.Feature
'                   Set NewFeature = framework.GetClass()
'               --------------------------------------------------------------------------
' Assumptions:  -
' Parameters:   -
...
' ---------------------------------
Public Function GetClass() As Feature
On Error GoTo Err_Handler

    Set GetClass = New Feature
    ...
    Select Case Err.Number
        Case Else
            MsgBox "Error #" & Err.Description, vbCritical, _
                "Error encounter (#" & Err.Number & " - GetClass[Feature class])"
    End Select
    Resume Exit_Handler
End Function
