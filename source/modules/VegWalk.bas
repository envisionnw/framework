...
'                   Dim NewVegWalk as framework.VegWalk
'                   Set NewVegWalk = framework.GetClass()
'               --------------------------------------------------------------------------
' Assumptions:  -
' Parameters:   -
...
' ---------------------------------
Public Function GetClass() As VegWalk
On Error GoTo Err_Handler

    Set GetClass = New VegWalk
    ...
    Select Case Err.Number
        Case Else
            MsgBox "Error #" & Err.Description, vbCritical, _
                "Error encounter (#" & Err.Number & " - GetClass[VegWalk class])"
    End Select
    Resume Exit_Handler
End Function
